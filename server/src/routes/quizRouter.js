...
const { createQuiz, getQuiz, createQuestion, getListQuestion, getRandomListQuestion, getQuestion, createResult, getListResult } = require("../controller/quizController");
